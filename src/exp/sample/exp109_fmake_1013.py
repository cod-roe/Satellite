...
# %%
# 集計の欠損値を後の値で埋める
status_df[["shift1_start", "cumsum_start", "shift1_end", "cumsum_end"]] = status_df[
    ["shift1_start", "cumsum_start", "shift1_end", "cumsum_end"]
].fillna(0)
status_df.head()
...
status_df["dayofweek _hour_6m_min"] = (
    status_df.groupby(["station_id", "dayofweek", "hour"])["bikes_available"]
