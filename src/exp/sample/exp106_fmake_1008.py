...
status_df["weekday_hour_1m_min"] = (
    status_df.groupby(["station_id", "weekday", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=4, min_periods=1).min())
    .interpolate(method="bfill")
)
...
status_df["weekday_hour_3m_std"] = (
    status_df.groupby(["station_id", "weekday", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=13, min_periods=1).std())
    .interpolate(method="bfill")
)

status_df["weekday_hour_3m_min"] = (
    status_df.groupby(["station_id", "weekday", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=13, min_periods=1).min())
    .interpolate(method="bfill")
)

status_df["weekday_hour_3m_max"] = (
    status_df.groupby(["station_id", "weekday", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=13, min_periods=1).max())
    .interpolate(method="bfill")
)
...
status_df["weekday_hour_6m_std"] = (
    status_df.groupby(["station_id", "weekday", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=25, min_periods=1).std())
    .interpolate(method="bfill")
)

status_df["weekday_hour_6m_min"] = (
    status_df.groupby(["station_id", "weekday", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=25, min_periods=1).min())
    .interpolate(method="bfill")
)

status_df["weekday_hour_6m_max"] = (
    status_df.groupby(["station_id", "weekday", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=25, min_periods=1).max())
    .interpolate(method="bfill")
)
...
status_df["hour_1w_min"] = (
    status_df.groupby(["station_id", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=7, min_periods=1).min())
    .interpolate(method="bfill")
)

status_df["hour_1w_max"] = (
    status_df.groupby(["station_id", "hour"])["bikes_available"]
...
status_df["hour_3m_std"] = (
    status_df.groupby(["station_id", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=90, min_periods=1).std())
    .interpolate(method="bfill")
)

status_df["hour_3m_min"] = (
    status_df.groupby(["station_id", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=90, min_periods=1).min())
    .interpolate(method="bfill")
)

status_df["hour_3m_max"] = (
    status_df.groupby(["station_id", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=90, min_periods=1).max())
    .interpolate(method="bfill")
)


# 6month
status_df["hour_6m_mean"] = (
    status_df.groupby(["station_id", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=180, min_periods=1).mean())
    .interpolate(method="bfill")
)

status_df["hour_6m_std"] = (
    status_df.groupby(["station_id", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=180, min_periods=1).std())
    .interpolate(method="bfill")
)


status_df["hour_6m_min"] = (
    status_df.groupby(["station_id", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=180, min_periods=1).min())
    .interpolate(method="bfill")
)

status_df["hour_6m_max"] = (
    status_df.groupby(["station_id", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=180, min_periods=1).max())
    .interpolate(method="bfill")
)
...
status_df["90_mean"] = (
    ...
    .transform(lambda x: x.rolling(window=2160, min_periods=1).mean())
    .interpolate(method="bfill")
)
# 180
status_df["180_mean"] = (
    status_df.groupby(["station_id", "hour"])["bikes_available"]
    .transform(lambda x: x.rolling(window=43420, min_periods=1).mean())
    .interpolate(method="bfill")
)
...
# 90/180
status_df["90/180"] = status_df["90_mean"] / status_df["180_mean"]
